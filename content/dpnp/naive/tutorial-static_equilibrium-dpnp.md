...
```{code-cell}
# cordUnit = cordDirection / np.linalg.norm(cordDirection)                             # Original code to be executed on the CPU
cordUnit = cordDirection / dpnp.asnumpy(dpnp.linalg.norm(dpnp.asarray(cordDirection))) # DPNP usage of linalg.norm
...
```{code-cell}
# momentCord = np.cross(forceCord, poleDirection)                                           # Original code to be executed on the CPU
momentCord = dpnp.asnumpy(dpnp.cross(dpnp.asarray(forceCord), dpnp.asarray(poleDirection))) # DPNP usage of cross
...
# UnitBD = BD / np.linalg.norm(BD)                             # Original code to be executed on the CPU
# UnitBE = BE / np.linalg.norm(BE)                             # Original code to be executed on the CPU
# UnitCF = CF / np.linalg.norm(CF)                             # Original code to be executed on the CPU
UnitBD = BD / dpnp.asnumpy(dpnp.linalg.norm(dpnp.asarray(BD))) # DPNP usage of linalg.norm
UnitBE = BE / dpnp.asnumpy(dpnp.linalg.norm(dpnp.asarray(BE))) # DPNP usage of linalg.norm
UnitCF = CF / dpnp.asnumpy(dpnp.linalg.norm(dpnp.asarray(CF))) # DPNP usage of linalg.norm

# RadBD = np.cross(AB, UnitBD)                                           # Original code to be executed on the CPU
# RadBE = np.cross(AB, UnitBE)                                           # Original code to be executed on the CPU
# RadCF = np.cross(AC, UnitCF)                                           # Original code to be executed on the CPU
RadBD = dpnp.asnumpy(dpnp.cross(dpnp.asarray(AB), dpnp.asarray(UnitBD))) # DPNP usage of cross
RadBE = dpnp.asnumpy(dpnp.cross(dpnp.asarray(AB), dpnp.asarray(UnitBE))) # DPNP usage of cross
RadCF = dpnp.asnumpy(dpnp.cross(dpnp.asarray(AC), dpnp.asarray(UnitCF))) # DPNP usage of cross
```
